# -*- coding: utf-8 -*-
"""
Created on Tue Nov 18 00:11:04 2025
...
data_ref = np.loadtxt('air_wg85_delay_2.txt', skiprows=1)
data_sam = np.loadtxt('sam_wg85_delay_2.txt', skiprows=1)
...
plt.title('Time-domain terahertz waveform ($85^\circ$)')
plt.xlabel('Time (ps)')
plt.ylabel('Signal')
plt.legend()
plt.grid(True)
